...
<section class="products" style="margin-top: 2.4rem; min-height:100vh;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         ...
         <input type="number" name="qty" class="qty" min="1" onkeypress="if(this.value.length == 2) return false;" value="1">
      </div>
